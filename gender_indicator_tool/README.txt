...
What's Next:
  ...
  * Customize it by editing the implementation file: ``gender_indicator_tool.py``

  * Create your own custom icon, replacing the default icon.png

  * Modify your user interface by opening GenderIndicatorTool_dialog_base.ui in Qt Designer
