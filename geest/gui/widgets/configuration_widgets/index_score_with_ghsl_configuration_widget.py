...
class IndexScoreWithGHSLConfigurationWidget(BaseConfigurationWidget):
    """
    A specialized radio button with additional widgets for IndexScore with GHSL.
    """
    ...
    def add_internal_widgets(self) -> None:
        ...
        try:
            self.info_label: QLabel = QLabel(
                "Fill each polygon with a fixed value, masking the results with the Global Human Settlements Layer."
            )
