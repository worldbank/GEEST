...
class ClassifiedPolygonWidget(BaseIndicatorWidget):
    """
    ...
    The user can choose layers either from the QGIS project or provide external shapefiles.

    The user can choose a numeric field from the selected polygon layer to classify the polygons into classes.
    ...
    def add_internal_widgets(self) -> None:
        ...
        try:
            ...
            self.widget_key = "classify_polygon_into_classes"
    ...
    def _add_field_selection_widgets(self) -> None:
        ...
        self.field_selection_combo.setFilters(QgsFieldProxyModel.Numeric)
